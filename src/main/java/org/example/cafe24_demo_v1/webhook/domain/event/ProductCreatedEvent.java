...
/**
 * Cafe24 쇼핑몰에 신규 상품이 등록됐을 때 발행되는 도메인 이벤트.
 *
 * WebhookController가 Cafe24로부터 상품 생성 Webhook을 수신하면 이 이벤트를 발행한다.
...
public class ProductCreatedEvent {
    ...
    private final String mallId;     // 상품이 등록된 쇼핑몰 ID
    private final Long productNo;    // 등록된 상품 번호
    private final LocalDateTime occurredAt;

    public ProductCreatedEvent(Integer eventNo, String mallId, Long productNo) {
