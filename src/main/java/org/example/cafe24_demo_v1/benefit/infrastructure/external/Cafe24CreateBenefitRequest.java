...
class Cafe24CreateBenefitRequest {
    ...
    static Cafe24CreateBenefitRequest from(CreateBenefitCommand command) {
        Cafe24CreateBenefitRequest req = new Cafe24CreateBenefitRequest();
        ...
        body.setBenefitDivision(command.benefitDivision());
        body.setBenefitType(command.benefitType());
