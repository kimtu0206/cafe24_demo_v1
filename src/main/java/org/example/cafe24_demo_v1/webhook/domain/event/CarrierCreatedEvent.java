...
/**
 * Cafe24 쇼핑몰에 신규 배송사가 등록됐을 때 발행되는 도메인 이벤트.
 *
 * WebhookController가 Cafe24로부터 배송사 등록 Webhook을 수신하면 이 이벤트를 발행한다.
...
public class CarrierCreatedEvent {
    ...
    private final String shippingCarrierCode;   // 등록된 배송사 코드
    private final LocalDateTime occurredAt;

    public CarrierCreatedEvent(Integer eventNo, String mallId, String shippingCarrierCode) {
